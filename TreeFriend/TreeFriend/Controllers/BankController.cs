...
namespace TreeFriend.Controllers {
    ...
    public class BankController : Controller {
        ...
        private BankInfoModel _bankInfoModel = new BankInfoModel {
            ...
            ReturnURL = "https://5d97-1-164-244-135.ngrok.io",
            NotifyURL = "https://5d97-1-164-244-135.ngrok.io/Bank/SpgatewayReturn",
            CustomerURL = "https://5d97-1-164-244-135.ngrok.io",
        ...
        public async Task SpgatewayPayBillAsync(int Buyercount, int InputlectureId) {
            ...
            TradeInfo tradeInfo = new TradeInfo() {
                ...
                // 支付取消 返回商店網址
                ClientBackURL = "https://5d97-1-164-244-135.ngrok.io/home/index",
                // * 付款人電子信箱
                Email = string.Empty,
